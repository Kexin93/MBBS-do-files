...
esttab est1 est2 est3 est4 using "$output\allwomen_husband_toIV_ITT.tex", replace fragment label nolines ///
...
prehead("\begin{table}\begin{center}\caption{Treatment Effect of the Partner Invitation Intervention}\label{tab: allwomenhusbandITT}\tabcolsep=0.1cm\scalebox{0.88}{\begin{tabular}{lcccc}\toprule") ///
...
esttab est1 est2 est3 est4 using "$output\allwomen_husband_toIV_ITT.tex", append fragment label nomtitles nonumbers nolines cells(b(star fmt(%9.3f)) ///
