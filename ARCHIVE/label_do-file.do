...
label var preprimary "Education: None"
label var educ_primary "Education: Primary"
label var educ_second "Education: Secondary"
label var educ_higher "Education: Higher"
...
label var COUN__FV_1 "Women attended the counseling session"
...
label var diff_method_8 "Changes in stated preferred method (from pre-counseling to follow-up)"
label var diff_method_3 "Changes in method use (from counseling to follow-up)"
...
label var method_attribute_con2 "Method use at counseling was included in the list of FP methods that were counseled on"
label var method_attribute_con1 "Stated preferred method at pre-counseling was included in the list of FP methods that were counseled on"
label var method_attribute_con3 "Pre-counseling stated preferred method = method use at counseling, and both were included in the list of methods that were counseled on"
label var method_attribute_con5 "Pre-counseling stated preferred method is DIFFERENT from method use at counseling, and both were included in the list of methods that were counseled on"
...
label var BL_Ideal_Method0 "Stated preferred method at BL: None"
label var BL_Ideal_Method4 "Stated preferred method at BL: Injectables" 
label var BL_Ideal_Method5 "Stated preferred method at BL: Implants"
label var modern_methods_BLideal "Stated preferred method at BL: Other modern methods (sterilization/IUD/pills/condoms)"
label var traditional_methods_BLideal "Stated preferred method at BL: Other traditional methods (standard days method/withdrawal)" 
label var COUN_303_None "Stated preferred method at Post-counseling: None"
label var COUN_303_inj "Stated preferred method at Post-counseling: Injectables"
label var COUN_303_implants "Stated preferred method at Post-counseling: Implants"
label var COUN_303_modern "Stated preferred method at Post-counseling: Other modern methods (sterilization/IUD/pills/condoms)"
label var COUN_303_traditional "Stated preferred method at Post-counseling: Other traditional methods (Two-day method/withdrawal)"
label var COUN__HUSB_1210 "Male partner's stated preferred method at pre-counseling: None"
label var COUN__HUSB_1214 "Male partner's stated preferred method at pre-counseling: Injectables"
label var COUN__HUSB_1215 "Male partner's stated preferred method at pre-counseling: Implants"
label var husb_ideal_other_modern "Male partner's stated preferred method at pre-counseling: Other modern methods (sterilization/IUD/pills/condoms/other modern methods)"
label var husb_ideal_traditional "Male partner's stated preferred method at pre-counseling: Other traditional methods (rhythm method/withdrawal/other traditional methods)"
...
label var diff_method111 "Changes in stated preferred method from baseline to pre-counseling"
label var diff_method112 "Changes in stated preferrd method from baseline to post-counseling"
label var diff_method113 "Changes in stated preferred method from baseline to follow-up"
label var diff_method114 "Changes in stated preferred method from pre-counseling to post-counseling"
label var diff_method115 "Changes in stated preferred method from pre-counseling to follow-up"
label var diff_method116 "Changes in stated preferred method from post-counseling to follow-up"
label var diff_method117 "Changes in method use from baseline to counseling"
label var diff_method118 "Changes in method use from baseline to follow-up"
label var diff_method119 "Changes in method use from counseling to follow-up"
...
label var HOM_REC_1 "Woman is available for the home-based interview"
label var anyClinic "In the past month, woman visited the Good Health (Kauma clinic), a pharmacy, or hospital to receive any family planning services"
