...
coeflabel(treatment0 "\makecell[l]{Standard Counseling, \\ Individual Counseling}" treatment1 "\makecell[l]{Standard Counseling, \\ Partner Invitations}" treatment2 "\makecell[l]{Standard Counseling, \\ Individual Counseling}" treatment3 "\makecell[l]{Tailored Counseling, \\ Partner Invitations}") ///
prehead("\begin{table}\begin{center}\caption{Treatment Effect of the Four Treatment Arms}\label{tab: allwomen4arms}\tabcolsep=0.3cm\scalebox{0.75}{\begin{tabular}{lcc}\toprule") ///
