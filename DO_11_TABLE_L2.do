...
******************* 1. PANEL A: Husband Invitation on End-of-Counseling Ideal Method **********************************************
	eststo clear														
	eststo: reg postIdeal_implants HUSB_T $covariates1 if !mi(COUN_3081), vce(robust) 
	summarize postIdeal_implants if HUSB_T == 0 & !mi(COUN_3081)
	estadd scalar ymean = r(mean)

	eststo: reg postIdeal_injectables HUSB_T $covariates1 if !mi(COUN_3081), vce(robust) 
	summarize postIdeal_injectables if HUSB_T == 0 & !mi(COUN_3081)
	estadd scalar ymean = r(mean)

	eststo: reg postIdeal_pills HUSB_T $covariates1 if !mi(COUN_3081), vce(robust) 
	summarize postIdeal_pills if HUSB_T == 0 & !mi(COUN_3081)
	estadd scalar ymean = r(mean)

	eststo: reg postIdeal_Others HUSB_T $covariates1 if !mi(COUN_3081), vce(robust) 
...
* ============================ 4. FUP ideal Method = injectables ========================================
	eststo clear
eststo: reg FUPIdeal_implants HUSB_T $covariates1 if !mi(COUN_3081), vce(robust) 
summarize FUPIdeal_implants if HUSB_T == 0 & !mi(COUN_3081)
estadd scalar ymean = r(mean)

eststo: reg FUPIdeal_injectables HUSB_T $covariates1 if !mi(COUN_3081), vce(robust) 
summarize FUPIdeal_injectables if HUSB_T == 0 & !mi(COUN_3081)
estadd scalar ymean = r(mean)

eststo: reg FUPIdeal_pills HUSB_T $covariates1 if !mi(COUN_3081), vce(robust) 
summarize FUPIdeal_pills if HUSB_T == 0 & !mi(COUN_3081)
estadd scalar ymean = r(mean)

eststo: reg FUPIdeal_Others HUSB_T $covariates1 if !mi(COUN_3081), vce(robust) 
