...
**# COUN_303
	eststo clear	
eststo: reg diff_method114 SHORT_T if COUN__FV_1 == 1, vce(robust) 
summarize diff_method114 if SHORT_T == 0 & COUN__FV_1 == 1
estadd scalar ymean = r(mean)

eststo: reg diff_method114 SHORT_T $balance_covariates if COUN__FV_1 == 1, vce(robust) 
summarize diff_method114 if SHORT_T == 0 & COUN__FV_1 == 1
estadd scalar ymean = r(mean)
	
eststo: reg diff_method116 SHORT_T if COUN__FV_1 == 1, vce(robust) 
summarize diff_method116 if SHORT_T == 0 & COUN__FV_1 == 1
estadd scalar ymean = r(mean)
	
eststo: reg diff_method116 SHORT_T $balance_covariates if COUN__FV_1 == 1, vce(robust) 
summarize diff_method116 if SHORT_T == 0 & COUN__FV_1 == 1
estadd scalar ymean = r(mean)
...
**# COUN_303 - COUN_3081
	eststo clear	
eststo: reg diff_method_23 SHORT_T if COUN__FV_1 == 1, vce(robust) 
summarize diff_method_23 if SHORT_T == 0 & COUN__FV_1 == 1
estadd scalar ymean = r(mean)

eststo: reg diff_method_23 SHORT_T $balance_covariates if COUN__FV_1 == 1, vce(robust) 
summarize diff_method_23 if SHORT_T == 0 & COUN__FV_1 == 1
estadd scalar ymean = r(mean)
