...
eststo clear 
eststo all: quietly estpost summarize $DESCVARS2
eststo HUSBT: quietly estpost summarize $DESCVARS2 if HUSB_T == 1 
eststo HUSB_invitation: quietly estpost summarize $DESCVARS2 if COUN_207 == 1
eststo HUSB_presence: quietly estpost summarize $DESCVARS2 if COUN_311 == 1
...
prehead("\begin{table}\begin{center}\caption{Partner Invitation}\label{tab: partnerAdoption}\tabcolsep=0.2cm\scalebox{0.85}{\begin{tabular}{lcccc}\toprule") ///
