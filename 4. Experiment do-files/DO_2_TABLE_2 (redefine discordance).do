...
******************* Panel C: post-COUN ideal method and FUP current method**********************************************
	eststo clear
eststo: reg same_method_9 SHORT_T, vce(robust) 
summarize same_method_9 if SHORT_T == 0
estadd scalar ymean = r(mean)

eststo: reg same_method_9 SHORT_T $balance_covariates, vce(robust) 
summarize same_method_9 if SHORT_T == 0
estadd scalar ymean = r(mean)

eststo: reg same_method_9 HUSB_T, vce(robust) 
summarize same_method_9 if HUSB_T == 0
estadd scalar ymean = r(mean)

eststo: reg same_method_9 HUSB_T $balance_covariates, vce(robust) 
summarize same_method_9 if HUSB_T == 0
estadd scalar ymean = r(mean)
...
******************* Panel D: FUP ideal method and FUP current method**********************************************
	eststo clear
eststo: reg same_method_5 SHORT_T if COUN__FV_1 == 1, vce(robust) 
summarize same_method_5 if SHORT_T == 0 & COUN__FV_1 == 1
estadd scalar ymean = r(mean)

eststo: reg same_method_5 SHORT_T $balance_covariates if COUN__FV_1 == 1, vce(robust) 
summarize same_method_5 if SHORT_T == 0 & COUN__FV_1 == 1
estadd scalar ymean = r(mean)

eststo: reg same_method_5 HUSB_T if COUN__FV_1 == 1, vce(robust) 
summarize same_method_5 if HUSB_T == 0 & COUN__FV_1 == 1
estadd scalar ymean = r(mean)
	
eststo: reg same_method_5 HUSB_T $balance_covariates if COUN__FV_1 == 1, vce(robust) 
summarize same_method_5 if HUSB_T == 0 & COUN__FV_1 == 1
estadd scalar ymean = r(mean)
