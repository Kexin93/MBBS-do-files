...
coeflabel(treatment0 "\makecell[l]{T0: Standard Counseling, \\ No Partner Invitations}" treatment1 "\makecell[l]{T1: Standard Counseling, \\ Partner Invitations}" treatment2 "\makecell[l]{T2: Standard Counseling, \\ No Partner Invitations}" treatment3 "\makecell[l]{T3: Tailored Counseling, \\ Partner Invitations}") ///
